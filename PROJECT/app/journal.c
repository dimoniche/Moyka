...
void SaveEventRecord(CPU_INT08U channel, CPU_INT08U event, CPU_INT16U data)
{
    ...
    // найти самую старую по времени запись и добавить новую после неЄ
